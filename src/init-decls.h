...
extern void nr_text_mono(uint32_t *nr, int nr_width, int nr_height, int x , int y , const char *str, uint32_t color, int fontsize, double hjust, double vjust, bool use_alpha);
